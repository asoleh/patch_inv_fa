...
//merubah Jarak Sub_total,Shipping,Total_Invoice dari bottomMargin menjadi 20.5 dari 15
    		$rep->row = $rep->bottomMargin + (18.5 * $rep->lineHeight);
			...
			{
				$rep->NewLine(1.3);
				$rep->TextCol(0, 1, $myrow['terbilang'] . "Terbilang : ");
				$rep->Font('italic');
				$rep->TextCol(1, 7, $myrow['terbilang'] ."( " . $words."Rupiah )", - 2);
				$rep->Font();
			}
			$rep->Font();
			if ($email == 1)
